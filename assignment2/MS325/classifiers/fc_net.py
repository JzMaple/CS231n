...
from MS325.layers import *
from MS325.layer_utils import *
...
class FullyConnectedNet(object):
    ...
    def __init__(self, hidden_dims, input_dim=1*28*28, num_classes=10,
        ...
        for i, hd in enumerate(hidden_dims):
            self.params['W%d'%(i+1)] = np.random.normal(0, weight_scale, size = (layer_input_dim, hidden_dims[i]))
        ...
        self.params['W%d'%(self.num_layers)] = np.random.normal(0, weight_scale, size = (layer_input_dim, num_classes))
